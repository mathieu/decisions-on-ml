...
echo "Deploy Ruleapp..."
curl -k -v -H "Content-Type: application/octet-stream" --data-binary @'./decision-service-projects/Miniloan Service/output/miniloan-with-ml-ruleapps-backup.jar' -u odmAdmin:odmAdmin http://localhost:9080/res/apiauth/v1/ruleapps
