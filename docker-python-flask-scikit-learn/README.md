...
```console
curl http://127.0.0.1:3000/prediction/api/v1.0?model=loan-default-svm&version=1.0&creditScore=397&income=160982&loanAmount=570189&monthDuration=240&rate=0.07&yearlyReimbursement=57195
```
